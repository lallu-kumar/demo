$(document).ready(function() {
        ...
        e ? t.remove() : (setTimeout(function() {
            ...
            strings: ["WEB DEVELOPER", "UI - UX DESIGNER", "SOFTWARE ENGINEER", "FREELANCER"],
            stringsElement: null,
            typeSpeed: 20,
            backSpeed: 3,
            backDelay: 500,
    ...
    function() {
        ...
        t("click", ".mobile-nav-toggle", function(t) {
            e("#navbar").classList.toggle("navbar-mobile"), this.classList.toggle("fa-bars"), this.classList.toggle("fa-times")
        ...
        r && new Waypoint({
            ...
            if (o) {
                ...
                t("click", "#portfolio-flters li", function(e) {
                    e.preventDefault(), a.forEach(function(e) {
